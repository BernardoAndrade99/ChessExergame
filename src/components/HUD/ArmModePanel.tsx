...
export const ArmModePanel: React.FC = () => {
  ...
  const statusText = !armModeEnabled
    ? 'Disabled'
    : isHighlighting
    ? `${pieceLabels[handGesturePieceType!] ?? 'Pieces'} highlighted — point right hand to choose`
      ...
      {armModeEnabled ? (
        <div style={{
          ...
          {[
            ...
            { emoji: '✋', gesture: 'Four fingers (stop hand)', piece: 'King' },
            { emoji: '🖐', gesture: 'Open palm (five wide)', piece: 'Queen' },
